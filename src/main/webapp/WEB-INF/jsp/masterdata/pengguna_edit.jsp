...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12">
				<form id="form" action="/update_pengguna?id=${pengguna.id}" method="post">
						...
						<tbody class="data">
							<tr>
								...
								<td>
									...
									<input type="text" id="namaPengguna" name="namaPengguna" class="form-control" value="${pengguna.namaPengguna}" /></div>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div style="width: 200px;">
										 <input type="text" id="alamat" name="alamat" class="form-control" value="${pengguna.alamat}" />
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class='input-group date' id='datepicker' style="width: 200px;">
										<input type='text' id="tglLhr" name="tglLhr" class="form-control" value="${pengguna.tglLhr}" placeholder="Tanggal..." required /> <span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span>
										</span>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div style="width: 200px;">
										<input type='text' id="tmpLhr" name="tmpLhr" class="form-control" value="${pengguna.tmpLhr}" required />
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<div style="width: 200px;">
										<input type="text" id="noTlp" name="noTlp" class="form-control" value="${pengguna.noTlp}" />
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div style="width: 300px;">
										<input type="text" id="ket" name="ket" class="form-control" value="${pengguna.ket}" />
									</div>
								</td>
							</tr>
